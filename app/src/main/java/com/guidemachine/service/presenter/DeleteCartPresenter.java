...
public class DeleteCartPresenter implements Presenter {
    ...
    private DeleteCartView mBaseView;
    private BaseBean mBaseBean;

    public DeleteCartPresenter(Context mContext) {
    ...
    public void attachView(View view) {
        mBaseView = (DeleteCartView) view;//把请求下来的实体类交给View来处理。
    }
    ...
    public void deleteCart(RequestBody requestBody) {//网络请求就开始
        mCompositeSubscription.add(manager.deleteCart(requestBody)//向CompositeSubscription添加一个订阅关系
