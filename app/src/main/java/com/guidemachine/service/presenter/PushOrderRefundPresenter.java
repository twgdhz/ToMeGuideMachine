...
* @create 2018/10/12 0012 11:41
* description: 申请退款
*/

public class PushOrderRefundPresenter implements Presenter {
    ...
    public PushOrderRefundPresenter(Context mContext) {
    ...
    public void commitOrderSale(RequestBody requestBody) {//网络请求就开始
        mCompositeSubscription.add(manager.pushOrderRefund(requestBody)//向CompositeSubscription添加一个订阅关系
