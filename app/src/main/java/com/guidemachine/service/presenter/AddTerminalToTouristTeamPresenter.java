...
public class AddTerminalToTouristTeamPresenter implements Presenter {
    ...
    public AddTerminalToTouristTeamPresenter(Context mContext) {
    ...
    public void allotTerminalToTouristTeam(RequestBody requestBody) {//网络请求就开始
        mCompositeSubscription.add(manager.allotTerminalToTouristTeam(requestBody)//向CompositeSubscription添加一个订阅关系
