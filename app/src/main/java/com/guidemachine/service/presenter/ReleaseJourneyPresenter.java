...
public class ReleaseJourneyPresenter implements Presenter {
    ...
    public ReleaseJourneyPresenter(Context mContext) {
    ...
    public void releaseJourney(RequestBody requestBody) {//网络请求就开始
        mCompositeSubscription.add(manager.issuanceTrip(requestBody)//向CompositeSubscription添加一个订阅关系
