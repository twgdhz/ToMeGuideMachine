...
public class PostFaceCheckCompletePresenter implements Presenter {
    ...
    public PostFaceCheckCompletePresenter(Context mContext) {
    ...
    public void postFaceCheckComplete(RequestBody requestBody) {//网络请求就开始
        mCompositeSubscription.add(manager.postFaceCheckComplete(requestBody)//向CompositeSubscription添加一个订阅关系
