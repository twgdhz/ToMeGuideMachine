...
public class ClearJourneyPresenter implements Presenter {
    ...
    public ClearJourneyPresenter(Context mContext) {
    ...
    public void clearTrip(RequestBody requestBody) {//网络请求就开始
        mCompositeSubscription.add(manager.clearTrip(requestBody)//向CompositeSubscription添加一个订阅关系
