 ...
 * 导游添加围栏
 */
public class GuideAddFencePresenter implements Presenter {
    ...
    public GuideAddFencePresenter(Context mContext) {
    ...
    public void addfence(RequestBody requestBody) {//网络请求就开始
        mCompositeSubscription.add(manager.addfence(requestBody)//向CompositeSubscription添加一个订阅关系
