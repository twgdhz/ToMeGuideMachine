 ...
 * 导游绑定围栏
 */
public class GuideBindFencePresenter implements Presenter {
    ...
    public GuideBindFencePresenter(Context mContext) {
    ...
    public void updatefencebyguide(RequestBody requestBody) {//网络请求就开始
        mCompositeSubscription.add(manager.updatefencebyguide(requestBody)//向CompositeSubscription添加一个订阅关系
