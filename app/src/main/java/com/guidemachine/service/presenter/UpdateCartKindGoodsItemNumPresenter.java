...
public class UpdateCartKindGoodsItemNumPresenter implements Presenter {
    ...
    public UpdateCartKindGoodsItemNumPresenter(Context mContext) {
    ...
    public void updateCartKindGoodsItemNum(RequestBody requestBody) {//网络请求就开始
        mCompositeSubscription.add(manager.updateCartKindGoodsItemNum(requestBody)//向CompositeSubscription添加一个订阅关系
