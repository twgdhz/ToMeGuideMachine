...
public class CancelOrderPresenter implements Presenter {
    ...
    public CancelOrderPresenter(Context mContext) {
    ...
    public void cancelKindOrder(RequestBody requestBody) {//网络请求就开始
        mCompositeSubscription.add(manager.cancelOrder(requestBody)//向CompositeSubscription添加一个订阅关系
