...
import com.guidemachine.ui.superadmin.chart.utils.DateUtil;
...
//        description.setText("需要展示的内容");
     ...
     * @param color    曲线颜色
     */
    public void showLineChart(final List<AdminStatisticsBean> dataList, String name, int color) {
...
//                return DateUtil.formatDateToMD(tradeDate);
     ...
     * 添加曲线
     */
    public void addLine(List<AdminStatisticsBean> dataList, String name, int color) {
        List<Entry> entries = new ArrayList<>();
        for (int i = 0; i < dataList.size(); i++) {
            AdminStatisticsBean data = dataList.get(i);
