...
import com.guidemachine.ui.activity.chat.fragment.ContactListFragment;
import com.guidemachine.ui.activity.chat.fragment.ConversationListFragment;
 ...
 * @create 2018/11/15 0015 15:20
 * description: 聊天主页面，这个页面相当于环信demo里面的MainActivity
 */
public class ChatActivity extends BaseActivity {
    public static ChatActivity activityInstance;
    private EaseContactListFragment contactListFragment;//会话
    private EaseConversationListFragment conversationListFragment;//通讯录
    ...
    protected void InitialView() {
        StatusBarUtils.setWindowStatusBarColor(ChatActivity.this, R.color.text_color4);
...
//                        contactListFragment.refresh();
        ...
        broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (action.equals(Constant.ACTION_GROUP_CHANAGED)) {
                    if (EaseCommonUtils.getTopActivity(ChatActivity.this).equals(GroupsActivity.class.getName())) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    if (ChatActivity.activityInstance != null && ChatActivity.activityInstance.toChatUsername != null &&
                        ...
                        Toast.makeText(ChatActivity.this, ChatActivity.activityInstance.getToChatUsername() + st10, Toast.LENGTH_LONG)
                                .show();
    ...
    EMClientListener clientListener = new EMClientListener() {
        ...
        public void onMigrate2x(boolean success) {
            Toast.makeText(ChatActivity.this, "onUpgradeFrom 2.x to 3.x " + (success ? "success" : "fail"), Toast.LENGTH_LONG).show();
            if (success) {
                refreshUIWithMessage();
            }
        }
...
//    }
    ...
    private void showExceptionDialog(String exceptionType) {
        ...
        if (!ChatActivity.this.isFinishing()) {
            ...
            try {
                if (exceptionBuilder == null)
                    exceptionBuilder = new android.app.AlertDialog.Builder(ChatActivity.this);
