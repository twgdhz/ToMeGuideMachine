...
* @create 2018/11/15 0015 16:15
* description: https://blog.csdn.net/qq_32519693/article/details/76726525
*/
public class CompletedView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mProgress > 0 ) {
            ...
            canvas.drawArc(oval, 0, ((float)mProgress / mTotalProgress) * 360, false, mRingPaint); //
