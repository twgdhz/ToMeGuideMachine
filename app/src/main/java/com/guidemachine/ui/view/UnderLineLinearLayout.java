...
/**
 * 时间轴
 * https://blog.csdn.net/u012416955/article/details/53433287
 */
public class UnderLineLinearLayout extends LinearLayout {
    ...
    public UnderLineLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int iconRes = attr.getResourceId(R.styleable.UnderLineLinearLayout_icon_src, R.mipmap.ic_logistics_first);
