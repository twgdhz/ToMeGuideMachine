...
public class LocationService {
    ...
    public LocationService(Context locationContext) {
        synchronized (objLock) {
            if (client == null) {
                ...
                client.setLocOption(getDefaultLocationClientOption(locationContext));
            }
        }
    }
    ...
    public LocationClientOption getDefaultLocationClientOption(Context context) {
        if (mOption == null) {
            ...
            if (!SPHelper.getInstance(context).getLocationMode().equals("")) {
                int time = Integer.parseInt(SPHelper.getInstance(context).getLocationMode());
